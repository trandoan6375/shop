<header>
    @php $menushtml=  \App\Helpers\Helper::menus($menus1); @endphp
    <!-- Header desktop -->
        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    <a href="error403" class="flex-c-m trans-04 p-lr-25">
                        Help & FAQs
                    </a>
                    <a href="adminlogin" class="flex-c-m trans-04 p-lr-25">
                        Login Admin
                    </a>
                </div>
            </div>
            ...
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li>
                            <a href="about.html">Thông tin liên hệ</a>
                        </li>
                    </ul>
                </div>
