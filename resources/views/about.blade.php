            ...
            <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                    <div class="p-t-15">
                        ...
                        <div class="bor8 bg0 m-b-12">
                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="address" placeholder="Đia chỉ Giao hàng">
                        </div>
                        <div class="bor8 bg0 m-b-12">
                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="email" placeholder="Email liên hệ">
                        </div>
                        <div class="bor8 bg0 m-b-12">
                            <textarea class="cl8 plh3 size-111 p-lr-15" style="height: 130px;" name="content" placeholder="ghi chú"></textarea>
                        </div>
                    </div>
                </div>
...
<div class="wrap-modal1 js-modal1 p-t-60 p-b-20">
    ...
    <div class="container">
        <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
            ...
            <div class="row">
                <!-- Hiện thị chi tiết sản phẩm use ajax -->
